package cn.thisfree.autocode.about;
...
public class AboutDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		txtSdfdSdfs.setText("代码生成器，希望能节约大家重复编码的时间\r\n\r\n本代码生成器生成的代码基于thisfree基础开发框架，thisfree开发框架是快速、安全、高效的开发框架。\r\n\r\n本代码生成器只是简单的代码生成功能，更复杂的功能，请您使用过程中提出，以便完善\r\n\r\n如果您有好的建议：请EMAIL: 729759393@qq.com");
		...
		lblgitlikewindmanemailsomedayqqcom.setText("huangxiaolong    EMAIL:  729759393@qq.com");
		new Label(composite_1, SWT.NONE);
