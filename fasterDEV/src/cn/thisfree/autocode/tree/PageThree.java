...
class ColumnLabelProvider extends LabelProvider implements ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		switch (columnIndex) {
		case 3:
			result = getImage(col.getIsPrimaryKey());
			break;
		case 4:
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 1:
			...
			break;
		case 2:
			result = col.getColumnComment() == null ? "" : col.getColumnComment();
			break;
		case 7:
...
class ColumnCellModifier implements ICellModifier {
	...
	public Object getValue(Object element, String property) {
		...
		case 1:
			...
			break;
		case 2:
			result = col.getColumnComment();
			break;
		case 3:
			result = new Boolean(!col.getIsPrimaryKey());
			break;
		case 4:
